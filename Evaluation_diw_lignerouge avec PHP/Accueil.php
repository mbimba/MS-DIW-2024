...
<div class="container-fluid mt-3  pt-5 card text-center" style="background-color: #4A394a;">  <!--         ICI LES 3 PREMIERES CATÉGORIES DE PLATS SUR LA PAGE ACCUEIL     -->
  <div class="row ">
...
<div class="container-fluid mt-3  pt-5 card text-center " style="background-color: #4A394a;">  <!--         ICI LES 3 AUTRES CATÉGORIES DE PLATS SUR LA PAGE ACCUEIL     -->
  <div class="row ">
...
<div class="container-fluid mt-3  pt-5 card text-center" style="background-color: #4A394a;">
  <div class="row ">
    <div class="col-sm-4 p-3 bg-dark text-white">
      <div class="img-fluid">
