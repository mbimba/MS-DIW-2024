...
<div class="container d-grid gap-2 d-md-block">
        <button class="btn btn-dark col-sm-1 boutonsuivetprec" onclick="redirectToAnotherPageburger()" type="button"> Précédent</button>
        <button class="btn btn-dark col-sm-1 boutonsuivetprec" onclick="redirectToAnotherPagepate()"type="button"> Suivant </button>
</div>
