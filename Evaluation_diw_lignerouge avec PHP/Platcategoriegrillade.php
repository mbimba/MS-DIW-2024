...
<div class="d-grid gap-2 d-md-block">
        <button class="btn btn-dark  boutonsuivetprec" onclick="redirectToAnotherPageburger()" type="button"> PRECEDENT</button>
        <button class="btn btn-dark boutonsuivetprec" onclick="redirectToAnotherPagepate()"type="button"> SUIVANT </button>
</div>
