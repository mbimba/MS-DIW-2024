...
<div class="d-grid gap-2 d-md-block">
        <button class="btn btn-dark  boutonsuivetprec" onclick="redirectToAnotherPagegrillade()" type="button"> PRECEDENT</button>
        <button class="btn btn-dark boutonsuivetprec" onclick="redirectToAnotherpizza()"type="button"> SUIVANT </button>
</div>
