...
<div class="container d-grid gap-2 d-md-block">
        <button class="btn btn-dark col-sm-1 boutonsuivetprec" onclick="redirectToAnotherPagegrillade()" type="button"> Précédent</button>
        <button class="btn btn-dark col-sm-1 boutonsuivetprec" onclick="redirectToAnotherpizza()"type="button"> Suivant </button>
</div>
